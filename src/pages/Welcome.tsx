    ...
    <div className="min-h-screen bg-gradient-hero flex items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 animate-fade-in-up">
        ...
        <Button
          ...
          size="lg"
          className="group relative bg-primary hover:bg-primary/90 text-primary-foreground px-12 py-6 text-lg font-semibold rounded-2xl shadow-2xl shadow-primary/50 transition-all duration-300 hover:shadow-primary/70 hover:scale-105"
        >
